 ...
 * {@link net.filipvanlaenen.nombrajkolektoj.BigIntegers.ModifiableSortedBigIntegerMap} interface.
 *
 * @param <K> The key type.
 */
abstract class ModifiableSortedBigIntegerMapDecorator<K> extends ModifiableBigIntegerMapDecorator<K>
        implements ModifiableSortedBigIntegerMap<K> {
    ...
    @Override
    abstract ModifiableSortedMap<K, BigInteger> getDecoratedMap();
    ...
    public OrderedBigIntegerCollection getValues() {
        return new OrderedBigIntegerCollection.ArrayCollection(getDecoratedMap().getValues());
    }
