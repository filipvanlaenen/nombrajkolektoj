 ...
 * {@link net.filipvanlaenen.nombrajkolektoj.BigIntegers.UpdatableSortedBigIntegerMap} interface.
 *
 * @param <K> The key type.
 */
abstract class UpdatableSortedBigIntegerMapDecorator<K> extends UpdatableBigIntegerMapDecorator<K>
        implements UpdatableSortedBigIntegerMap<K> {
    @Override
    ...
    @Override
    abstract UpdatableSortedMap<K, BigInteger> getDecoratedMap();
