 ...
 * {@link net.filipvanlaenen.nombrajkolektoj.doubles.UpdatableSortedDoubleMap} interface.
 *
 * @param <K> The key type.
 */
abstract class UpdatableSortedDoubleMapDecorator<K> extends UpdatableDoubleMapDecorator<K>
        implements UpdatableSortedDoubleMap<K> {
    @Override
    ...
    @Override
    abstract UpdatableSortedMap<K, Double> getDecoratedMap();
