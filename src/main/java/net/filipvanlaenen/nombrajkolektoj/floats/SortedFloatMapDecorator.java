 ...
 * {@link net.filipvanlaenen.nombrajkolektoj.floats.SortedFloatMap} interface.
 *
 * @param <K> The key type.
 */
abstract class SortedFloatMapDecorator<K> extends FloatMapDecorator<K> implements SortedFloatMap<K> {
    @Override
    ...
    @Override
    abstract SortedMap<K, Float> getDecoratedMap();
