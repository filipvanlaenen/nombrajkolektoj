 ...
 * {@link net.filipvanlaenen.nombrajkolektoj.shorts.ModifiableSortedShortMap} interface.
 *
 * @param <K> The key type.
 */
abstract class ModifiableSortedShortMapDecorator<K> extends ModifiableShortMapDecorator<K>
        implements ModifiableSortedShortMap<K> {
    ...
    @Override
    abstract ModifiableSortedMap<K, Short> getDecoratedMap();
    ...
    public OrderedShortCollection getValues() {
        return new OrderedShortCollection.ArrayCollection(getDecoratedMap().getValues());
    }
