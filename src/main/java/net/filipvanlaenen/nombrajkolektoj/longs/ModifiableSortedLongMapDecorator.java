 ...
 * {@link net.filipvanlaenen.nombrajkolektoj.longs.ModifiableSortedLongMap} interface.
 *
 * @param <K> The key type.
 */
abstract class ModifiableSortedLongMapDecorator<K> extends ModifiableLongMapDecorator<K>
        implements ModifiableSortedLongMap<K> {
    ...
    @Override
    abstract ModifiableSortedMap<K, Long> getDecoratedMap();
