...
/**
 * A numeric collection containing integers. In addition to the functionality of collections in general, it supports
...
public interface IntegerCollection extends NumericCollection<Integer> {
    /**
     * A numeric collection containing integers and backed by an array. It implements the
    ...
    /**
     * A numeric collection containing integers and backed by a hash. It implements the
     * {@link net.filipvanlaenen.nombrajkolektoj.integers.IntegerCollection} interface by decorating an
