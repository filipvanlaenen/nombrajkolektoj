...
/**
 * A numeric collection containing floats. In addition to the functionality of collections in general, it supports
...
public interface FloatCollection extends NumericCollection<Float> {
    /**
     * A numeric collection containing floats and backed by an array. It implements the
    ...
    /**
     * A numeric collection containing floats and backed by a hash. It implements the
     * {@link net.filipvanlaenen.nombrajkolektoj.floats.FloatCollection} interface by decorating an
