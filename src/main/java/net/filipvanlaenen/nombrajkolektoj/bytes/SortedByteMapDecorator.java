 ...
 * {@link net.filipvanlaenen.nombrajkolektoj.bytes.SortedByteMap} interface.
 *
 * @param <K> The key type.
 */
abstract class SortedByteMapDecorator<K> extends ByteMapDecorator<K> implements SortedByteMap<K> {
    @Override
    ...
    @Override
    abstract SortedMap<K, Byte> getDecoratedMap();
