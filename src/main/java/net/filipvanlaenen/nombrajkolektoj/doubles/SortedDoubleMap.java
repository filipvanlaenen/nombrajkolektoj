...
/**
 * A sorted numeric map containing doubles. It doesn't support any new functionality in addition to the functionality of
 * sorted maps in general and doubles maps.
 *
 * This interface extends the generic {@link net.filipvanlaenen.nombrajkolektoj.SortedNumericMap} interface binding the
 * type parameter to Double. It contains two nested classes implementing this interface, one backed by an
 ...
 */
public interface SortedDoubleMap<K> extends SortedNumericMap<K, Double>, DoubleMap<K> {
    /**
     * A sorted numeric map containing doubles and backed by an array. It implements the
     * {@link net.filipvanlaenen.nombrajkolektoj.doubles.SortedDoubleMap} interface by decorating an
     * {@link net.filipvanlaenen.kolektoj.array.SortedArrayMap}.
     *
     * @param <K> The key type.
     */
    public static final class ArrayMap<K> extends SortedDoubleMapDecorator<K> {
        /**
         * The internal decorated map.
         */
        private SortedArrayMap<K, Double> decoratedMap;
        ...
        public ArrayMap(final Comparator<? super K> comparator, final Entry<K, Double>... entries) {
            decoratedMap = new SortedArrayMap<K, Double>(comparator, entries);
        }
        ...
        public ArrayMap(final Comparator<? super K> comparator, final Map<? extends K, Double> source) {
            decoratedMap = new SortedArrayMap<K, Double>(comparator, source);
        }
        ...
        public ArrayMap(final KeyAndValueCardinality keyAndValueCardinality, final Comparator<? super K> comparator,
            ...
            decoratedMap = new SortedArrayMap<K, Double>(keyAndValueCardinality, comparator, entries);
        }
        ...
        public ArrayMap(final KeyAndValueCardinality keyAndValueCardinality, final Comparator<? super K> comparator,
            ...
            decoratedMap = new SortedArrayMap<K, Double>(keyAndValueCardinality, comparator, source);
        }

        @Override
        SortedMap<K, Double> getDecoratedMap() {
            return decoratedMap;
        }
    }

    /**
     * A sorted numeric map containing doubles and backed by a sorted tree. It implements the
     * {@link net.filipvanlaenen.nombrajkolektoj.doubles.SortedDoubleMap} interface by decorating an
     * {@link net.filipvanlaenen.kolektoj.sortedtree.SortedTreeMap}.
     *
     * @param <K> The key type.
     */
    public static final class SortedTreeMap<K> extends SortedDoubleMapDecorator<K> {
        /**
         * The internal decorated map.
         */
        private net.filipvanlaenen.kolektoj.sortedtree.SortedTreeMap<K, Double> decoratedMap;
        ...
        public SortedTreeMap(final Comparator<? super K> comparator, final Entry<K, Double>... entries) {
            decoratedMap = new net.filipvanlaenen.kolektoj.sortedtree.SortedTreeMap<K, Double>(comparator, entries);
        }
        ...
        public SortedTreeMap(final Comparator<? super K> comparator, final Map<? extends K, Double> source) {
            decoratedMap = new net.filipvanlaenen.kolektoj.sortedtree.SortedTreeMap<K, Double>(comparator, source);
        }
        ...
        public SortedTreeMap(final KeyAndValueCardinality keyAndValueCardinality,
            ...
            decoratedMap = new net.filipvanlaenen.kolektoj.sortedtree.SortedTreeMap<K, Double>(keyAndValueCardinality,
                    comparator, entries);
        }
     ...
     */
    static <L> SortedDoubleMap<L> empty(final Comparator<? super L> comparator) {
     ...
     */
    static <L> SortedDoubleMap<L> of(final Comparator<? super L> comparator, final Entry<L, Double>... entries) {
     ...
     */
    static <L> SortedDoubleMap<L> of(final Comparator<? super L> comparator, final L key, final Double value) {
     ...
     */
    static <L> SortedDoubleMap<L> of(final Comparator<? super L> comparator, final L key1, final Double value1,
     ...
     */
    static <L> SortedDoubleMap<L> of(final Comparator<? super L> comparator,
     ...
     * @return A new sorted doubles map with the specified entries.
     */
    static <L> SortedDoubleMap<L> of(final KeyAndValueCardinality keyAndValueCardinality,
     ...
     */
    static <L> SortedDoubleMap<L> of(final SortedNumericMap<L, Double> map) {
     ...
     * @return A new sorted doubles map cloned from the provided sorted doubles map.
     */
    static <L> SortedDoubleMap<L> of(final SortedNumericMap<L, Double> map, final Range<L> range) {
