...
/**
 * A numeric collection containing shorts. In addition to the functionality of collections in general, it supports
...
public interface ShortCollection extends NumericCollection<Short> {
    /**
     * A numeric collection containing shorts and backed by an array. It implements the
    ...
    /**
     * A numeric collection containing shorts and backed by a hash. It implements the
     * {@link net.filipvanlaenen.nombrajkolektoj.shorts.ShortCollection} interface by decorating an
