 ...
 */
public abstract class SortedBigDecimalCollectionDecoratorTestBase<T extends SortedBigDecimalCollection>
        extends OrderedBigDecimalCollectionDecoratorTestBase<T> {
    /**
