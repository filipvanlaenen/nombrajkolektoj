 ...
 * {@link net.filipvanlaenen.nombrajkolektoj.bytes.UpdatableSortedByteMap} interface.
 *
 * @param <K> The key type.
 */
abstract class UpdatableSortedByteMapDecorator<K> extends UpdatableByteMapDecorator<K>
        implements UpdatableSortedByteMap<K> {
    @Override
    ...
    @Override
    abstract UpdatableSortedMap<K, Byte> getDecoratedMap();
