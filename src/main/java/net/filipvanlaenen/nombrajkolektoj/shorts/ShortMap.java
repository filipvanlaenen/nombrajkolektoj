...
public abstract class ShortMap<K> extends AbstractShortMap<K> implements NumericMap<K, Short> {
     ...
     */
    static <K> ShortMap<K> of(final Entry<K, Short>... entries) {
     ...
     * @return A new shorts map with the specified entries.
     */
    static <K> ShortMap<K> of(final KeyAndValueCardinality keyAndValueCardinality, final Entry<K, Short>... entries) {
     ...
     */
    public static <K> ShortMap<K> of(final K key, final Short value) {
     ...
     */
    public static <K> ShortMap<K> of(final K key1, final Short value1, final K key2, final Short value2) {
