 ...
 * {@link net.filipvanlaenen.nombrajkolektoj.BigDecimals.UpdatableBigDecimalMap} interface.
 *
 * @param <K> The key type.
 */
abstract class UpdatableBigDecimalMapDecorator<K> extends BigDecimalMapDecorator<K> implements UpdatableBigDecimalMap<K> {
    @Override
    ...
    @Override
    abstract UpdatableMap<K, BigDecimal> getDecoratedMap();
