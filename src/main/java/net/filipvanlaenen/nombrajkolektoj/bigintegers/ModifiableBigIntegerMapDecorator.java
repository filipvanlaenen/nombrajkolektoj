 ...
 * {@link net.filipvanlaenen.nombrajkolektoj.BigIntegers.ModifiableBigIntegerMap} interface.
 *
 * @param <K> The key type.
 */
abstract class ModifiableBigIntegerMapDecorator<K> extends UpdatableBigIntegerMapDecorator<K>
        implements ModifiableBigIntegerMap<K> {
    @Override
    ...
    @Override
    abstract ModifiableMap<K, BigInteger> getDecoratedMap();
