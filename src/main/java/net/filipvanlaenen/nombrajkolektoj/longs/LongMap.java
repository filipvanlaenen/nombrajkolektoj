...
public abstract class LongMap<K> extends AbstractLongMap<K> implements NumericMap<K, Long> {
     ...
     */
    static <K> LongMap<K> of(final Entry<K, Long>... entries) {
     ...
     * @return A new longs map with the specified entries.
     */
    static <K> LongMap<K> of(final KeyAndValueCardinality keyAndValueCardinality, final Entry<K, Long>... entries) {
     ...
     */
    public static <K> LongMap<K> of(final K key, final Long value) {
     ...
     */
    public static <K> LongMap<K> of(final K key1, final Long value1, final K key2, final Long value2) {
