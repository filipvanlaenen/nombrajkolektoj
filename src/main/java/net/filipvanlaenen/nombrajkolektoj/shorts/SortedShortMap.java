...
import net.filipvanlaenen.nombrajkolektoj.shorts.UpdatableShortMap.HashMap;
 ...
 */
public class SortedShortMap<K> extends AbstractSortedShortMap<K> implements SortedNumericMap<K, Short> {
    /**
