...
public abstract class UpdatableSortedIntegerMap<K> extends AbstractUpdatableSortedIntegerMap<K>
    ...
    public static final class ArrayMap<K> extends UpdatableSortedIntegerMap<K> {
        ...
        public ArrayMap(final Comparator<? super K> comparator, final Entry<K, Integer>... entries) {
            super(new UpdatableSortedArrayMap<K, Integer>(comparator, entries));
        }
        ...
        public ArrayMap(final Comparator<? super K> comparator, final Map<? extends K, Integer> source) {
            super(new UpdatableSortedArrayMap<K, Integer>(comparator, source));
        }
        ...
        public ArrayMap(final KeyAndValueCardinality keyAndValueCardinality, final Comparator<? super K> comparator,
            ...
            super(new UpdatableSortedArrayMap<K, Integer>(keyAndValueCardinality, comparator, entries));
        }
        ...
        public ArrayMap(final KeyAndValueCardinality keyAndValueCardinality, final Comparator<? super K> comparator,
            ...
            super(new UpdatableSortedArrayMap<K, Integer>(keyAndValueCardinality, comparator, source));
        }
    }
    ...
    public static final class SortedTreeMap<K> extends UpdatableSortedIntegerMap<K> {
        ...
        public SortedTreeMap(final Comparator<? super K> comparator, final Entry<K, Integer>... entries) {
            super(new UpdatableSortedTreeMap<K, Integer>(comparator, entries));
        }
        ...
        public SortedTreeMap(final Comparator<? super K> comparator, final Map<? extends K, Integer> source) {
            super(new UpdatableSortedTreeMap<K, Integer>(comparator, source));
        }
        ...
        public SortedTreeMap(final KeyAndValueCardinality keyAndValueCardinality,
            ...
            super(new UpdatableSortedTreeMap<K, Integer>(keyAndValueCardinality, comparator, entries));
        }
        ...
        public SortedTreeMap(final KeyAndValueCardinality keyAndValueCardinality,
            ...
            super(new UpdatableSortedTreeMap<K, Integer>(keyAndValueCardinality, comparator, source));
        }
    }
