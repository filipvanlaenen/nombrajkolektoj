 ...
 * {@link net.filipvanlaenen.nombrajkolektoj.BigIntegers.UpdatableBigIntegerMap} interface.
 *
 * @param <K> The key type.
 */
abstract class UpdatableBigIntegerMapDecorator<K> extends BigIntegerMapDecorator<K> implements UpdatableBigIntegerMap<K> {
    @Override
    ...
    @Override
    abstract UpdatableMap<K, BigInteger> getDecoratedMap();
