 ...
 * {@link net.filipvanlaenen.nombrajkolektoj.BigIntegers.SortedBigIntegerMap} interface.
 *
 * @param <K> The key type.
 */
abstract class SortedBigIntegerMapDecorator<K> extends BigIntegerMapDecorator<K> implements SortedBigIntegerMap<K> {
    @Override
    ...
    @Override
    abstract SortedMap<K, BigInteger> getDecoratedMap();
