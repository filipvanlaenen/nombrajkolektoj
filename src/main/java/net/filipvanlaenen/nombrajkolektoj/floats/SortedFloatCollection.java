 ...
 */
public interface SortedFloatCollection extends SortedNumericCollection<Float>, OrderedFloatCollection {
    /**
    ...
    public static final class ArrayCollection extends SortedFloatCollectionDecorator {
        ...
        public ArrayCollection(final Comparator<? super Float> comparator, final Float... numbers) {
            decoratedCollection = new SortedArrayCollection<Float>(comparator, numbers);
        }
        ...
        public ArrayCollection(final ElementCardinality elementCardinality, final Comparator<? super Float> comparator,
            ...
            decoratedCollection = new SortedArrayCollection<Float>(elementCardinality, comparator,
    ...
    public static final class SortedTreeCollection extends SortedFloatCollectionDecorator {
        ...
        public SortedTreeCollection(final Comparator<? super Float> comparator, final Float... numbers) {
            decoratedCollection =
                    new net.filipvanlaenen.kolektoj.sortedtree.SortedTreeCollection<Float>(comparator, numbers);
        }
