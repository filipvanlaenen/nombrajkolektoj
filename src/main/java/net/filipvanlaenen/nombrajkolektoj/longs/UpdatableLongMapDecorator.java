 ...
 * {@link net.filipvanlaenen.nombrajkolektoj.longs.UpdatableLongMap} interface.
 *
 * @param <K> The key type.
 */
abstract class UpdatableLongMapDecorator<K> extends LongMapDecorator<K> implements UpdatableLongMap<K> {
    @Override
    ...
    @Override
    abstract UpdatableMap<K, Long> getDecoratedMap();
