...
public abstract class IntegerMap<K> extends AbstractIntegerMap<K> implements NumericMap<K, Integer> {
    ...
    public static final class HashMap<K> extends IntegerMap<K> {
        ...
        public HashMap(final KeyAndValueCardinality keyAndValueCardinality, final Map<? extends K, Integer> source) {
            super(new net.filipvanlaenen.kolektoj.hash.HashMap<K, Integer>(keyAndValueCardinality, source));
        }
     ...
     */
    public static <L> IntegerMap<L> of(final L key, final Integer value) {
     ...
     */
    public static <L> IntegerMap<L> of(final L key1, final Integer value1, final L key2, final Integer value2) {
