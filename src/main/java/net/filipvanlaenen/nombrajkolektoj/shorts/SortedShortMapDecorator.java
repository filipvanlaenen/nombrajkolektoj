 ...
 * {@link net.filipvanlaenen.nombrajkolektoj.shorts.SortedShortMap} interface.
 *
 * @param <K> The key type.
 */
abstract class SortedShortMapDecorator<K> extends ShortMapDecorator<K> implements SortedShortMap<K> {
    @Override
    ...
    @Override
    abstract SortedMap<K, Short> getDecoratedMap();
