 ...
 * {@link net.filipvanlaenen.nombrajkolektoj.BigDecimals.ModifiableSortedBigDecimalMap} interface.
 *
 * @param <K> The key type.
 */
abstract class ModifiableSortedBigDecimalMapDecorator<K> extends ModifiableBigDecimalMapDecorator<K>
        implements ModifiableSortedBigDecimalMap<K> {
    ...
    @Override
    abstract ModifiableSortedMap<K, BigDecimal> getDecoratedMap();
    ...
    public OrderedBigDecimalCollection getValues() {
        return new OrderedBigDecimalCollection.ArrayCollection(getDecoratedMap().getValues());
    }
