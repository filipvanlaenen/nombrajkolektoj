 ...
 * {@link net.filipvanlaenen.nombrajkolektoj.integers.SortedIntegerMap} interface.
 *
 * @param <K> The key type.
 */
abstract class SortedIntegerMapDecorator<K> extends IntegerMapDecorator<K> implements SortedIntegerMap<K> {
    @Override
    ...
    @Override
    abstract SortedMap<K, Integer> getDecoratedMap();
