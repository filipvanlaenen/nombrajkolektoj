...
/**
 * A numeric map containing shorts. In addition to the functionality of maps in general, it supports calculating the
 ...
 * parameter for the values to Short. It contains one nested class implementing this interface, backed by
 ...
 */
public interface ShortMap<K> extends NumericMap<K, Short> {
    /**
     * A numeric map containing shorts and backed by a hash. It implements the
     * {@link net.filipvanlaenen.nombrajkolektoj.shorts.ShortMap} interface by decorating an
    ...
    public static final class HashMap<K> extends ShortMapDecorator<K> {
         ...
         */
        private net.filipvanlaenen.kolektoj.hash.HashMap<K, Short> decoratedMap;
        ...
        public HashMap(final Entry<K, Short>... entries) {
            decoratedMap = new net.filipvanlaenen.kolektoj.hash.HashMap<K, Short>(entries);
        }
        ...
        public HashMap(final KeyAndValueCardinality keyAndValueCardinality, final Entry<K, Short>... entries) {
            decoratedMap = new net.filipvanlaenen.kolektoj.hash.HashMap<K, Short>(keyAndValueCardinality, entries);
        }
        ...
        public HashMap(final KeyAndValueCardinality keyAndValueCardinality, final Map<? extends K, Short> source) {
            decoratedMap = new net.filipvanlaenen.kolektoj.hash.HashMap<K, Short>(keyAndValueCardinality, source);
        }
        ...
        public HashMap(final Map<? extends K, Short> source) {
            decoratedMap = new net.filipvanlaenen.kolektoj.hash.HashMap<K, Short>(source);
        }

        @Override
        Map<K, Short> getDecoratedMap() {
            return decoratedMap;
        }
    }
    ...
    /**
     * Returns a new shorts map with the specified key and value cardinality cloned from the provided shorts map.
     *
     * @param <L>                    The key type.
     * @param keyAndValueCardinality The key and value cardinality.
     * @param map                    The original shorts map.
     * @return A new shorts map with the specified key and value cardinality cloned from the provided shorts map.
     */
    static <L> ShortMap<L> of(final KeyAndValueCardinality keyAndValueCardinality,
     ...
     */
    static <L> ShortMap<L> of(final L key, final Short value) {
     ...
     */
    static <L> ShortMap<L> of(final L key1, final Short value1, final L key2, final Short value2) {
     ...
     */
    static <L> ShortMap<L> of(final L key1, final Short value1, final L key2, final Short value2, final L key3,
            final Short value3) {
        return new HashMap<L>(new Entry<L, Short>(key1, value1), new Entry<L, Short>(key2, value2),
     ...
     */
    static <L> ShortMap<L> of(final L key1, final Short value1, final L key2, final Short value2, final L key3,
            final Short value3, final L key4, final Short value4) {
        return new HashMap<L>(new Entry<L, Short>(key1, value1), new Entry<L, Short>(key2, value2),
     ...
     */
    static <L> ShortMap<L> of(final L key1, final Short value1, final L key2, final Short value2, final L key3,
            final Short value3, final L key4, final Short value4, final L key5, final Short value5) {
        return new HashMap<L>(new Entry<L, Short>(key1, value1), new Entry<L, Short>(key2, value2),
                new Entry<L, Short>(key3, value3), new Entry<L, Short>(key4, value4),
     ...
     */
    static <L> ShortMap<L> of(final NumericMap<? extends L, Short> map) {
        return new HashMap<L>(map);
    }

    /**
     * Returns a new shorts map with the specified key and value cardinality containing all the entries from the
     * provided shorts maps.
     *
     * @param <L>                    The key type.
     * @param keyAndValueCardinality The key and value cardinality.
     * @param maps                   The shorts maps from which to copy all the entries.
     * @return A new shorts map with the specified key and value cardinality containing all the entries from the
     *         provided shorts maps.
     */
    static <L> ShortMap<L> unionOf(final KeyAndValueCardinality keyAndValueCardinality,
    ...
    /**
     * Returns a new shorts map containing all the entries from the provided shorts maps.
     *
     * @param <L>  The key type.
     * @param maps The shorts maps from which to copy all the entries.
     * @return A new shorts map containing all the entries from the provided shorts maps.
     */
    static <L> ShortMap<L> unionOf(final NumericMap<? extends L, Short>... maps) {
