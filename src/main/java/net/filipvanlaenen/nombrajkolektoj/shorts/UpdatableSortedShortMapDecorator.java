 ...
 * {@link net.filipvanlaenen.nombrajkolektoj.shorts.UpdatableSortedShortMap} interface.
 *
 * @param <K> The key type.
 */
abstract class UpdatableSortedShortMapDecorator<K> extends UpdatableShortMapDecorator<K>
        implements UpdatableSortedShortMap<K> {
    @Override
    ...
    @Override
    abstract UpdatableSortedMap<K, Short> getDecoratedMap();
