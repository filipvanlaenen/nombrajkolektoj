...
/**
 * A sorted numeric map containing integers. It doesn't support any new functionality in addition to the functionality of
 * sorted maps in general and integers maps.
 *
 * This interface extends the generic {@link net.filipvanlaenen.nombrajkolektoj.SortedNumericMap} interface binding the
 * type parameter to Integer. It contains two nested classes implementing this interface, one backed by an
 ...
 */
public interface SortedIntegerMap<K> extends SortedNumericMap<K, Integer>, IntegerMap<K> {
    /**
     * A sorted numeric map containing integers and backed by an array. It implements the
     * {@link net.filipvanlaenen.nombrajkolektoj.integers.SortedIntegerMap} interface by decorating an
     * {@link net.filipvanlaenen.kolektoj.array.SortedArrayMap}.
     *
     * @param <K> The key type.
     */
    public static final class ArrayMap<K> extends SortedIntegerMapDecorator<K> {
        /**
         * The internal decorated map.
         */
        private SortedArrayMap<K, Integer> decoratedMap;
        ...
        public ArrayMap(final Comparator<? super K> comparator, final Entry<K, Integer>... entries) {
            decoratedMap = new SortedArrayMap<K, Integer>(comparator, entries);
        }
        ...
        public ArrayMap(final Comparator<? super K> comparator, final Map<? extends K, Integer> source) {
            decoratedMap = new SortedArrayMap<K, Integer>(comparator, source);
        }
        ...
        public ArrayMap(final KeyAndValueCardinality keyAndValueCardinality, final Comparator<? super K> comparator,
            ...
            decoratedMap = new SortedArrayMap<K, Integer>(keyAndValueCardinality, comparator, entries);
        }
        ...
        public ArrayMap(final KeyAndValueCardinality keyAndValueCardinality, final Comparator<? super K> comparator,
            ...
            decoratedMap = new SortedArrayMap<K, Integer>(keyAndValueCardinality, comparator, source);
        }

        @Override
        SortedMap<K, Integer> getDecoratedMap() {
            return decoratedMap;
        }
    }

    /**
     * A sorted numeric map containing integers and backed by a sorted tree. It implements the
     * {@link net.filipvanlaenen.nombrajkolektoj.integers.SortedIntegerMap} interface by decorating an
     * {@link net.filipvanlaenen.kolektoj.sortedtree.SortedTreeMap}.
     *
     * @param <K> The key type.
     */
    public static final class SortedTreeMap<K> extends SortedIntegerMapDecorator<K> {
        /**
         * The internal decorated map.
         */
        private net.filipvanlaenen.kolektoj.sortedtree.SortedTreeMap<K, Integer> decoratedMap;
        ...
        public SortedTreeMap(final Comparator<? super K> comparator, final Entry<K, Integer>... entries) {
            decoratedMap = new net.filipvanlaenen.kolektoj.sortedtree.SortedTreeMap<K, Integer>(comparator, entries);
        }
        ...
        public SortedTreeMap(final Comparator<? super K> comparator, final Map<? extends K, Integer> source) {
            decoratedMap = new net.filipvanlaenen.kolektoj.sortedtree.SortedTreeMap<K, Integer>(comparator, source);
        }
        ...
        public SortedTreeMap(final KeyAndValueCardinality keyAndValueCardinality,
            ...
            decoratedMap = new net.filipvanlaenen.kolektoj.sortedtree.SortedTreeMap<K, Integer>(keyAndValueCardinality,
                    comparator, entries);
        }
     ...
     */
    static <L> SortedIntegerMap<L> empty(final Comparator<? super L> comparator) {
     ...
     */
    static <L> SortedIntegerMap<L> of(final Comparator<? super L> comparator, final Entry<L, Integer>... entries) {
     ...
     */
    static <L> SortedIntegerMap<L> of(final Comparator<? super L> comparator, final L key, final Integer value) {
     ...
     */
    static <L> SortedIntegerMap<L> of(final Comparator<? super L> comparator, final L key1, final Integer value1,
    ...
    /**
     * Returns a new sorted integers map cloned from the provided integers map but sorted according to the comparator.
     *
     * @param <L>        The key type.
     * @param comparator The comparator by which to sort the keys.
     ...
     */
    static <L> SortedIntegerMap<L> of(final Comparator<? super L> comparator,
     ...
     * @return A new sorted integers map with the specified entries.
     */
    static <L> SortedIntegerMap<L> of(final KeyAndValueCardinality keyAndValueCardinality,
    ...
    /**
     * Returns a new sorted integers map cloned from the provided integers map with the specified key and value
     * cardinality.
     *
     * @param <L>                    The key type.
     * @param keyAndValueCardinality The key and value cardinality.
     * @param comparator             The comparator by which to sort the keys.
     * @param map                    The original integers map.
     * @return A new sorted integers map cloned from the provided integers map with the specified key and value
     *         cardinality.
     */
    static <L> SortedIntegerMap<L> of(final KeyAndValueCardinality keyAndValueCardinality,
    ...
    /**
     * Returns a new sorted integers map cloned from the provided sorted integers map.
     *
     * @param <L> The key type.
     * @param map The original sorted integers map.
     * @return A new sorted integers map cloned from the provided sorted integers map.
     */
    static <L> SortedIntegerMap<L> of(final SortedNumericMap<L, Integer> map) {
     ...
     * @return A new sorted integers map cloned from the provided sorted integers map.
     */
    static <L> SortedIntegerMap<L> of(final SortedNumericMap<L, Integer> map, final Range<L> range) {
