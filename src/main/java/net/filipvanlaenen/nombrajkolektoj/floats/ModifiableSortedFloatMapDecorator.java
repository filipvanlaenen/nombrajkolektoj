 ...
 * {@link net.filipvanlaenen.nombrajkolektoj.floats.ModifiableSortedFloatMap} interface.
 *
 * @param <K> The key type.
 */
abstract class ModifiableSortedFloatMapDecorator<K> extends ModifiableFloatMapDecorator<K>
        implements ModifiableSortedFloatMap<K> {
    ...
    @Override
    abstract ModifiableSortedMap<K, Float> getDecoratedMap();
