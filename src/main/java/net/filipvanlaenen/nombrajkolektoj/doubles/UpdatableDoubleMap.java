...
/**
 * An updatable numeric map containing doubles. In addition to the functionality of updatable maps in general and
 * doubles maps, it supports augmenting, subtracting, multiplying and dividing all the values of map with a number, and
 ...
 */
public interface UpdatableDoubleMap<K> extends UpdatableNumericMap<K, Double>, DoubleMap<K> {
    /**
     * An updatable numeric map containing doubles and backed by a hash. It implements the
     * {@link net.filipvanlaenen.nombrajkolektoj.doubles.UpdatableDoubleMap} interface by decorating an
    ...
    public static final class HashMap<K> extends UpdatableDoubleMapDecorator<K> {
         ...
         */
        private UpdatableHashMap<K, Double> decoratedMap;
        ...
        public HashMap(final Entry<K, Double>... entries) {
            decoratedMap = new UpdatableHashMap<K, Double>(entries);
        }
        ...
        public HashMap(final KeyAndValueCardinality keyAndValueCardinality, final Entry<K, Double>... entries) {
            decoratedMap = new UpdatableHashMap<K, Double>(keyAndValueCardinality, entries);
        }
        ...
        public HashMap(final KeyAndValueCardinality keyAndValueCardinality, final Map<? extends K, Double> source) {
            decoratedMap = new UpdatableHashMap<K, Double>(keyAndValueCardinality, source);
        }
        ...
        public HashMap(final Map<? extends K, Double> source) {
            decoratedMap = new UpdatableHashMap<K, Double>(source);
        }

        @Override
        UpdatableMap<K, Double> getDecoratedMap() {
            return decoratedMap;
        }
    }
     ...
     */
    static <L> UpdatableDoubleMap<L> empty() {
     ...
     */
    static <L> UpdatableDoubleMap<L> of(final Double defaultValue, final Collection<? extends L> keys) {
     ...
     * @return A new updatable doubles map with the specified entries.
     */
    static <L> UpdatableDoubleMap<L> of(final Double defaultValue, final L... keys) {
        ModifiableDoubleMap<L> map = ModifiableDoubleMap.<L>empty();
        for (L key : keys) {
            map.add(key, defaultValue);
        }
     ...
     */
    static <L> UpdatableDoubleMap<L> of(final Entry<L, Double>... entries) {
     ...
     * @return A new updatable doubles map with the specified entries.
     */
    static <L> UpdatableDoubleMap<L> of(final KeyAndValueCardinality keyAndValueCardinality, final Double defaultValue,
     ...
     * @return A new doubles map with the specified entries.
     */
    static <L> UpdatableDoubleMap<L> of(final KeyAndValueCardinality keyAndValueCardinality,
            final Entry<L, Double>... entries) {
        return new HashMap<L>(keyAndValueCardinality, entries);
    }

    /**
     * Returns a new doubles map cloned from the provided doubles map with the specified key and value cardinality.
     *
     * @param <L>                    The key type.
     * @param keyAndValueCardinality The key and value cardinality.
     * @param map                    The original doubles map.
     * @return A new doubles map cloned from the provided doubles map with the specified key and value cardinality.
     */
    static <L> UpdatableDoubleMap<L> of(final KeyAndValueCardinality keyAndValueCardinality,
     ...
     */
    static <L> UpdatableDoubleMap<L> of(final L key, final Double value) {
     ...
     */
    static <L> UpdatableDoubleMap<L> of(final L key1, final Double value1, final L key2, final Double value2) {
     ...
     */
    static <L> UpdatableDoubleMap<L> of(final NumericMap<? extends L, Double> map) {
        return new HashMap<L>(map);
    }

    /**
     * Returns a new updatable doubles map with the specified key and value cardinality containing all the entries from
     * the provided doubles maps.
     *
     * @param <L>                    The key type.
     * @param keyAndValueCardinality The key and value cardinality.
     * @param maps                   The doubles maps from which to copy all the entries.
     * @return A new updatable doubles map with the specified key and value cardinality containing all the entries from
     *         the provided doubles maps.
     */
    static <L> UpdatableDoubleMap<L> unionOf(final KeyAndValueCardinality keyAndValueCardinality,
    ...
    /**
     * Returns a new updatable doubles map containing all the entries from the provided doubles maps.
     *
     * @param <L>  The key type.
     * @param maps The doubles maps from which to copy all the entries.
     * @return A new updatable doubles map containing all the entries from the provided doubles maps.
     */
    static <L> UpdatableDoubleMap<L> unionOf(final NumericMap<? extends L, Double>... maps) {
