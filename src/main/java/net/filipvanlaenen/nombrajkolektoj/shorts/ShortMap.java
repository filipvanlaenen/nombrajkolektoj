...
public abstract class ShortMap<K> extends AbstractShortMap<K> implements NumericMap<K, Short> {
    ...
    public static final class HashMap<K> extends ShortMap<K> {
        ...
        public HashMap(final KeyAndValueCardinality keyAndValueCardinality, final Map<? extends K, Short> source) {
            super(new net.filipvanlaenen.kolektoj.hash.HashMap<K, Short>(keyAndValueCardinality, source));
        }
     ...
     *         provided shorts maps.
     */
    public static <L> ShortMap<L> unionOf(final KeyAndValueCardinality keyAndValueCardinality,
     ...
     */
    public static <L> ShortMap<L> unionOf(final NumericMap<? extends L, Short>... maps) {
