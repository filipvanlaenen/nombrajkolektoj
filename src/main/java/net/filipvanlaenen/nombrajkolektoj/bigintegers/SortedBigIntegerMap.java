...
public abstract class SortedBigIntegerMap<K> extends AbstractSortedBigIntegerMap<K> implements SortedNumericMap<K, BigInteger> {
     ...
     */
    static <K> SortedBigIntegerMap<K> empty(final Comparator<K> comparator) {
     ...
     */
    static <K> SortedBigIntegerMap<K> of(final Comparator<K> comparator, final Entry<K, BigInteger>... entries) {
     ...
     * @return A new sorted BigIntegers map with the specified entries.
     */
    static <K> SortedBigIntegerMap<K> of(final KeyAndValueCardinality keyAndValueCardinality,
     ...
     */
    public static <K> SortedBigIntegerMap<K> of(final Comparator<K> comparator, final K key, final BigInteger value) {
     ...
     */
    public static <K> SortedBigIntegerMap<K> of(final Comparator<K> comparator, final K key1, final BigInteger value1,
