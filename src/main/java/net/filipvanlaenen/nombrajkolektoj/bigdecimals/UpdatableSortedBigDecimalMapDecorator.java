 ...
 * {@link net.filipvanlaenen.nombrajkolektoj.BigDecimals.UpdatableSortedBigDecimalMap} interface.
 *
 * @param <K> The key type.
 */
abstract class UpdatableSortedBigDecimalMapDecorator<K> extends UpdatableBigDecimalMapDecorator<K>
        implements UpdatableSortedBigDecimalMap<K> {
    @Override
    ...
    @Override
    abstract UpdatableSortedMap<K, BigDecimal> getDecoratedMap();
