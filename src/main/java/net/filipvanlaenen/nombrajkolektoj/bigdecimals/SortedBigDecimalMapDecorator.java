 ...
 * {@link net.filipvanlaenen.nombrajkolektoj.BigDecimals.SortedBigDecimalMap} interface.
 *
 * @param <K> The key type.
 */
abstract class SortedBigDecimalMapDecorator<K> extends BigDecimalMapDecorator<K> implements SortedBigDecimalMap<K> {
    @Override
    ...
    @Override
    abstract SortedMap<K, BigDecimal> getDecoratedMap();
